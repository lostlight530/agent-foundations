...
9. [August 1–30 evidence ledger](docs/AUGUST_2026_01_30_EVIDENCE_LEDGER.md) — commit-backed provisional daily/weekly/monthly map; `MONTH_OPEN`.
...
9. [8 月 1–30 日证据总账](docs/AUGUST_2026_01_30_EVIDENCE_LEDGER.md) — 基于提交的临时日/周/月映射；`MONTH_OPEN`。
