...
9. [August 1–30 evidence ledger](historical-audits/04-evidence-and-closure-ledgers/2026-08-30--august-01-30--evidence-ledger.md) — commit-backed provisional daily/weekly/monthly map; `MONTH_OPEN`.
...
9. [8 月 1–30 日证据总账](historical-audits/04-evidence-and-closure-ledgers/2026-08-30--august-01-30--evidence-ledger.md) — 基于提交的临时日/周/月映射；`MONTH_OPEN`。
