...
- DOI: `10.5281/zenodo.22791169`
- DOI resolver: `https://doi.org/10.5281/zenodo.22791169`
- Code repository: `https://github.com/lostlight530/agent-foundations`
...
A future archived release should preserve this record as point-in-time publication history and use its own confirmed release metadata. DOI presence, citation metadata, or archival availability does not by itself establish claim support, implementation status, validation status, scientific validity, or reproduction.
